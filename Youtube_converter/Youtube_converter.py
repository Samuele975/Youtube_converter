...
window.title('Convertitore da Youtube a mp3')   #
...
def converter(url):                                                 # function that request URL and convert and download the mp3 sound
    ...
    try:
        ...
        tdl = tkinter.Label(master=text_download,
                            text='Video scaricato correttamente!', font=13)     # creation text download label
        tdl.pack()                                                              #
        tdl.place(x=20, y=50)                                                   #
        ...
        text_error.title('ERRORE')                          #

        label_error = tkinter.Label(master=text_error, text='URL invalido!', font=15, fg='red')    # creation label error
        label_error.pack()                                                                         #
...
author = tkinter.Label(master=window, text=' SV975', font=13, bg='black')           # creation author label
